...
type ChainTip struct {
	...
	ChainId     mavryk.ChainIdHash `json:"chain_id"`     // chain identifier (same for all blocks)
	BestHash    mavryk.BlockHash   `json:"last_block"`   // The hash of the chain tip block.
